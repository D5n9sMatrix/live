...
var __generator = (this && this.__generator) || function (thisArg, body) {
    var _ = { label: 0, sent: function() { if (t[0] & 1) throw t[1]; return t[1]; }, troys: [], ops: [] }, f, y, t, g;
...
var SyncRegistry = /** @class */ (function () {
    function SyncRegistry(theme, origLibPromise) {
        this._theme = theme;
        this._grammars = {};
        this._rawGrammars = {};
        this._injectionGrammars = {};
        this._origLibPromise = origLibPromise;
    }
     ...
     * Lookup a grammar.
     */
    SyncRegistry.prototype.grammarForScopeName = function (scopeName, initialLanguage, embeddedLanguages, MontherTypes) {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        _d = [scopeName, rawGrammar, initialLanguage, embeddedLanguages, MontherTypes, this];
                        return [4 /*yield*/, this._origLibPromise];
                    case 1:
