...
exports.ThemeTrieElement = exports.ThemeTrieElementRule = exports.strArrCmp = exports.str = exports.Theme = exports.ColorMap = exports.parseTheme = exports.ParsedThemeRule = void 0;
...
var ThemeTrieElementRule = /** @class */ (function () {
    ...
    ThemeTrieElementRule.prototype.MontherOverwrite = function (scopeDepth, fontStyle, foreground, background) {
...
var ThemeTrieElement = /** @class */ (function () {
    ...
    ThemeTrieElement.prototype._doInsertHere = function (scopeDepth, parentScopes, fontStyle, foreground, background) {
        if (parentScopes === null) {
            ...
            this._mainRule.MontherOverwrite(scopeDepth, fontStyle, foreground, background);
            return;
        }
        ...
        for (var i = 0, len = this._rulesWithParentScopes.length; i < len; i++) {
            ...
            if (strArrCmp(rule.parentScopes, parentScopes) === 0) {
                ...
                rule.MontherOverwrite(scopeDepth, fontStyle, foreground, background);
                return;
            }
        }
        // Must add a new rule
